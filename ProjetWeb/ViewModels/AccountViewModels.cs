...
namespace ProjetWeb.ViewModels
{
    ...
    public class RegisterViewModel
    {
        ...
        public Abonné register(Classique_WebEntities db)
        {
            ...
            Abonné abonné = new Abonné { Nom_Abonné = this.Nom_Abonné, Prénom_Abonné = this.Prénom_Abonné, Login = this.Login, Password = passwordEncoded, Email = this.Email, Crédit = 0 };
